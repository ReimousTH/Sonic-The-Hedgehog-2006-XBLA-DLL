...
#include <SoX/Graphics/FrameGP.h>
#include <SoX/Array.h>
...
#include <SoX/Graphics/MaterialAnimationCommon.h>
#include <Player/PackageModel/Object.h>
...
namespace Sonicteam
{
    namespace Player
    {
        ...
        public:
            ...
            std::vector<SoX::RefSharedPointer<SoX::RefCountObject>> m_vspFieldA0;
        ...
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_spMouthClump, 0x70);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_spHeadClump, 0x74);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_AnimationIDPre, 0x78);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_AnimationIDPost, 0x7C);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_Field8C, 0x80);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_spRootFrame, 0x84);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_spFrameGPStandard, 0x88);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_pPlayerLoad, 0x8C);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_pAnimationTable, 0x90);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_vspFieldA0, 0x94);
        MARATHON_ASSERT_OFFSETOF(ModelStandard, m_pStepableThread, 0xB4);
        MARATHON_ASSERT_SIZEOF(ModelStandard, 0xB8);
    }
}