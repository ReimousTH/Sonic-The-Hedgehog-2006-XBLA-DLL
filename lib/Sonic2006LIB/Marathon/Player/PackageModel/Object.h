...
#include <SoX/Graphics/Motion.h>
#include <SoX/Graphics/Texture.h>
#include <SoX/Graphics/FrameGP.h>
#include <SoX/Graphics/InstanceModelCommon.h>
#include <SoX/Graphics/MotionHierarchy.h>
#include <SoX/Graphics/LocalAnimationUserDataListener.h>
    ...
    namespace Player
    {
        namespace PackageModel
        {
            ...
            public:
                ...
                std::vector<void*> m_vField8; // some Transform Data? size 0x70+-
                std::vector<void*> m_vField18; // some Transform Data? size 4 ?
                std::vector<void*> m_vField28; // ???
                ...
                std::vector<SoX::RefSharedPointer<SoX::Graphics::Motion>> m_vspMotionsRoot;
                std::vector<SoX::RefSharedPointer<SoX::Graphics::Motion>> m_vspMotionsFace;
                std::vector<ObjectTexture> m_vTextures;
